...
CLASS lcl_agent_info_provider DEFINITION CREATE PUBLIC.
  PUBLIC SECTION.
    INTERFACES zpru_if_agent_info_provider.
ENDCLASS.


CLASS lcl_syst_prompt_provider DEFINITION CREATE PUBLIC.
  PUBLIC SECTION.
    INTERFACES zpru_if_prompt_provider.
ENDCLASS.


CLASS lcl_abap_executor DEFINITION CREATE PUBLIC.
  PUBLIC SECTION.
...
CLASS lcl_knowledge_provider DEFINITION CREATE PUBLIC.
  PUBLIC SECTION.
    INTERFACES zpru_if_tool_executor.
...
CLASS lcl_nested_agent DEFINITION CREATE PUBLIC.
  PUBLIC SECTION.
    INTERFACES zpru_if_tool_executor.
...
CLASS lcl_tool_provider DEFINITION CREATE PUBLIC.
  PUBLIC SECTION.
    INTERFACES zpru_if_tool_provider.
ENDCLASS.


CLASS lcl_tool_info_provider DEFINITION CREATE PUBLIC.
  PUBLIC SECTION.
    INTERFACES zpru_if_tool_info_provider.
ENDCLASS.


CLASS lcl_schema_provider DEFINITION CREATE PUBLIC.
  PUBLIC SECTION.
